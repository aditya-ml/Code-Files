...
path =r'C:\ADITYA\Computervision\UCF50_videos\UCF50\Basketball'
...
i=0
path1 =r'C:\ADITYA\Computervision\UCF50_videos\UCF50\Basketball\\'
for dirpath,dirnames,filename in walk(path):
    # do your stuff

#for filename in glob.glob(os.path.join(path, '*.txt')):
    
    while i <=0 :#<= len(filename):
	...
	# show some information on the number of bounding boxes
           ...
           # print("[INFO] {}: {} original boxes, {} after suppression".format(
            ...
            path2=r'C:\ADITYA\Computervision\UCF50_videos\BaseballPitch_roi_v2\file_%d.jpg'%d
   ...
   # print(a)
            ...
            f_handle = open(r"C:\ADITYA\Computervision\UCF50_videos\UCF_new\BasketballROI\%s_roi.csv"%filename[i], 'a')
            ...
            if len(rects)!=0:
                ...
                cv2.imwrite(r'C:\ADITYA\Computervision\UCF50_videos\BaseballPitch _roi_v2\file_%d_roi.jpg'%d,crop_img)
